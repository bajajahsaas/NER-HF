...
#export OUT_DIR=./${DATASET}/${MODE}/${RANDOM_SEQ_LEN}/inference  # always make new directory, since code empties OUT_DIR and then writes

export TEST=./instabase-data/w2-classifier-instabase-test.csv
export OUT_DIR=./${DATASET}/${RANDOM_SEQ_LEN}/instabase-data  # always make new directory, since code empties OUT_DIR and then writes
