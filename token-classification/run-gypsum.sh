...
# export OUTPUT_DIR='/mnt/nfs/work1/696ds-s20/abajaj/instabase/models/germeval-model-multi'

export OUTPUT_DIR='/mnt/nfs/work1/696ds-s20/abajaj/instabase/models/WNUT-17'
